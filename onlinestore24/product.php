...
<nav id="navbar-auto-hidden">
    ...
    <!-- Fin Modal logout -->    <section id="store">
       <br>
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12">
                      ...
                      <li role="presentation" class="dropdown active">
                        ...
                        <ul class="dropdown-menu" role="menu" aria-labelledby="myTabDrop1" id="myTabDrop1-contents">
                          <!-- ==================== Lista categorias =============== -->
                                    ...
                                    <li>
                                        <a href="#C1" tabindex="-1" role="tab" id="C1-tab" data-toggle="tab" aria-controls="C1" aria-expanded="false">Cámaras
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#C2" tabindex="-1" role="tab" id="C2-tab" data-toggle="tab" aria-controls="C2" aria-expanded="false">Multimedia
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#C3" tabindex="-1" role="tab" id="C3-tab" data-toggle="tab" aria-controls="C3" aria-expanded="false">Móviles
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#C4" tabindex="-1" role="tab" id="C4-tab" data-toggle="tab" aria-controls="C4" aria-expanded="false">Portátiles
                                        </a>
                                    </li>                          <!-- ==================== Fin lista categorias =============== -->
                        </ul>
                      </li>
                    </ul>
                    <div id="myTabContent" class="tab-content">
                      ...
                      <div role="tabpanel" class="tab-pane fade active in" id="C1" aria-labelledby="C1-tab"><br>
                                        <div class="col-xs-12 col-sm-6 col-md-3">
                                             <div class="thumbnail">
                                               <a href="infoProd.php?CodigoProd=0001"><img src="assets/img-products/Camara Fujifilm Instax Mini 12 Instantanea.jpg"></a>
                                               <div class="caption">
                                         ...
                                         </div><div role="tabpanel" class="tab-pane fade active in" id="C2" aria-labelledby="C2-tab"><br>
                                        <div class="col-xs-12 col-sm-6 col-md-3">
                                             <div class="thumbnail">
                                               <a href="infoProd.php?CodigoProd=0002"><img src="assets/img-products/Speaker Amazon Echo Spot Alexa Smart 2024 con Reloj.jpg"></a>
                                               <div class="caption">
                                         ...
                                         </div><div role="tabpanel" class="tab-pane fade active in" id="C3" aria-labelledby="C3-tab"><br>
                                        <div class="col-xs-12 col-sm-6 col-md-3">
                                             <div class="thumbnail">
                                               <a href="infoProd.php?CodigoProd=0003"><img src="assets/img-products/Apple iPhone 15 Pro Max BE A.jpg"></a>
                                               <div class="caption">
                                         ...
                                         </div><div role="tabpanel" class="tab-pane fade active in" id="C4" aria-labelledby="C4-tab"><br>
                                        <div class="col-xs-12 col-sm-6 col-md-3">
                                             <div class="thumbnail">
                                               <a href="infoProd.php?CodigoProd=0004"><img src="assets/img-products/Notebook MSI Cyborg 15 A13VE-218 15.6 Intel Core i7-13620H RTX 4050 6 GB.jpg"></a>
                                               <div class="caption">
                                         ...
                                         </div>                      <!-- ==================== Fin contenedores de categorias =============== -->
                    </div>
                </div>
            </div>
        </div>
