                        ...
                        !$modelProd == "" && !$marcaProd == "" && !$stockProd == "" && !$codePProd == "" && !$_FILES['img']['name'] == "") {
                            ...
                            if($verificaltotal <= 0) {
                                if(move_uploaded_file($_FILES['img']['tmp_name'], "../assets/img-products/" . $_FILES['img']['name'])) {
                                    if(consultasSQL::InsertSQL("producto", "CodigoProd, NombreProd, CodigoCat, Precio, Modelo, Marca, Stock, RUCProveedor, Imagen, Nombre",
                                    "'$codeProd', '$nameProd', '$cateProd', '$priceProd', '$modelProd', '$marcaProd', '$stockProd', '$codePProd', '" . $_FILES['img']['name'] . "', '$adminProd'")) {
                                        echo '
                                            <img src="../assets/img/correctofull.png" class="center-all-contens">
                                            <br>
                                            <h3>El producto se añadió a la tienda con éxito</h3>
                                            <p class="lead text-center">
                                                La página se redireccionará automáticamente. Si no es así, haga clic en el siguiente botón.<br>
                                ...
                                echo '
                                    <img src="../assets/img/incorrectofull.png" class="center-all-contens">
                                    <br>
                                    <h3>El Código de producto ya está registrado.<br>Por favor, ingrese otro código de producto</h3>
                                    <p class="lead text-center">
                                        La página se redireccionará automáticamente. Si no es así, haga clic en el siguiente botón.<br>
                                        <a href="../configAdmin.php" class="btn btn-primary btn-lg">Volver a administración</a>
                                    </p>';
                            ...
                            echo '
                                <img src="../assets/img/incorrectofull.png" class="center-all-contens">
                                <br>
                                <h3>Error: los campos no deben estar vacíos</h3>
                                <p class="lead text-center">
                                    La página se redireccionará automáticamente. Si no es así, haga clic en el siguiente botón.<br>
                                    <a href="../configAdmin.php" class="btn btn-primary btn-lg">Volver a administración</a>
                                </p>';
