...
if(!$RUCCliente=="" && !$nameCliente=="" && !$apeCliente=="" && !$dirCliente=="" && !$phoneCliente=="" && !$emailCliente=="" && !$fullnameCliente==""){
	...
	if($verificaltotal<=0){
	if(consultasSQL::InsertSQL("cliente", "RUC, Nombre, NombreCompleto, Apellido, Direccion, Clave, Telefono, Email", "'$RUCCliente','$nameCliente','$fullnameCliente','$apeCliente','$dirCliente', '$passCliente','$phoneCliente','$emailCliente'")){
