...
<nav id="navbar-auto-hidden">  
    ...
    <div class="row visible-xs"><!-- Mobile menu navbar -->  
        <div class="col-xs-12">  
            ...
            <a href="#" id="button-shopping-cart-xs" class="elements-nav-xs all-elementstooltip carrito-button-nav" data-toggle="tooltip" data-placement="bottom" title="Ver carrito de compras">  
